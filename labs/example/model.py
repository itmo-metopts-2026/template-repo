...
Данный модуль содержит реализацию линейной регрессии «с нуля»,
без использования готовых библиотек машинного обучения (sklearn и т.п.).
...
где:
    - X ∈ ℝ^{n×m} — матрица признаков (n объектов, m признаков),
    - w ∈ ℝ^m     — вектор весов,
    - b ∈ ℝ       — свободный член (bias).

Обучение выполняется путём минимизации среднеквадратичной ошибки (MSE):
